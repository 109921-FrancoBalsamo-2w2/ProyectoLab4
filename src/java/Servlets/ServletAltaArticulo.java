...
public class ServletAltaArticulo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<tipoArticulosClase> lista = con.articulosTa();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        articulos.setCodigo(cod);
        articulos.setDenominacion(den);
        articulos.setPrecioUnitario(Double.parseDouble(preun));
        articulos.setIdta(Integer.parseInt(idTA));
        conexiones.insertArticulo(articulos);
